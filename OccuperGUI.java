...
public class OccuperGUI extends JFrame {
    ...
    public OccuperGUI() {
        ...
        setTitle("Gestion de la table Occuper");
        ...
        // Title
        JLabel title = new JLabel("Gestion de la table Occuper", JLabel.CENTER);
        ...
        scroll.setBorder(BorderFactory.createTitledBorder("Données de la table Occuper"));
    ...
    private void loadData(){
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM occuper ORDER BY id_classe");
    ...
    private void ajouter(){
        try {
            ...
            PreparedStatement pst = con.prepareStatement("INSERT INTO occuper (id_classe, id_ue) VALUES (?, ?)");
    ...
    private void supprimer(){
        try {
            ...
            PreparedStatement pst = con.prepareStatement("DELETE FROM occuper WHERE id_classe = ? AND id_ue = ?");
            pst.setInt(1, idClasse);
            pst.setString(2, idUE);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(OccuperGUI::new);
    }
}
